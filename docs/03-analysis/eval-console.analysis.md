...
> **Design Doc**: [eval-console.design.md](../02-design/features/eval-console.design.md)
...
| **runtime 섹션** — `/evals.runtime` 요약 + "Live usage" 카드 + 배지 `⚠` suspects 병기 | `aea3b1b` (runtime-telemetry) | 별도 feature — 자체 갭 분석 있음: [runtime-telemetry.analysis.md](runtime-telemetry.analysis.md) (88%→~100%). 콘솔은 그 소비면 |
