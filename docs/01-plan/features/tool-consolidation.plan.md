...
- 선행 feature: [self-verification.plan.md](self-verification.plan.md) (eval 하네스)
- Design: [tool-consolidation.design.md](../../02-design/features/tool-consolidation.design.md) (작성 예정)
